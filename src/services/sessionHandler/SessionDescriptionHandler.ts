...
import { TypeStrings, Exceptions, InviteClientContext, InviteServerContext, SessionDescriptionHandler as SessionDescriptionHandlerDefinition,
  SessionDescriptionHandlerModifiers, Utils, Session, Web  } from "sip.js";
...
export class SessionDescriptionHandler extends EventEmitter implements SessionDescriptionHandlerDefinition {
  ...
  public static defaultFactory(
    ...
    const logger: Logger = new Logger(new LoggerFactory(), "SIPJS");
